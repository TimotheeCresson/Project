...
var verifObstacle1 = setInterval(function () {
    var personnageTop = parseInt(window.getComputedStyle(personnage).getPropertyValue("top"));
    var obstacleleft = parseInt(window.getComputedStyle(obstacle1).getPropertyValue("left"))
...
var verifObstacle2 = setInterval(function () {
    var personnageTop = parseInt(window.getComputedStyle(personnage).getPropertyValue("top"));
    var personnage2Top = parseInt(window.getComputedStyle(personnage2).getPropertyValue("top"));
    ...
    var collisionPersonnage1 = obstacle2left < 80 && obstacle2left > 0 && personnageTop >= 200;
    var collisionPersonnage2 = obstacle2left < 80 && obstacle2left > 0 && personnage2Top >= 900;

    if (collisionPersonnage1 || collisionPersonnage2) {
